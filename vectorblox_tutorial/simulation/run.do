...
vcom -93 -explicit  -work COREGPIO_LIB "${PROJECT_DIR}/component/Actel/DirectCore/CoreGPIO/3.1.101/rtl/vhdl/core/coregpio_pkg.vhd"
vcom -93 -explicit  -work COREGPIO_LIB "${PROJECT_DIR}/component/Actel/DirectCore/CoreGPIO/3.1.101/rtl/vhdl/core/coregpio.vhd"
...
vcom -93 -explicit  -work COREGPIO_LIB "${PROJECT_DIR}/component/Actel/DirectCore/CoreGPIO/3.1.101/rtl/vhdl/core/components.vhd"
...
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/component/Actel/Simulation/CLK_GEN/1.0.1/CLK_GEN.vhd"
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/component/Actel/Simulation/RESET_GEN/1.0.1/RESET_GEN.vhd"
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/component/work/tb/tb.vhd"

vsim -L SmartFusion2 -L presynth -L COREAPB3_LIB -L COREAHBLITE_LIB -L COREAHBTOAPB3_LIB -L COREAHBLSRAM_LIB -L COREAXI_LIB -L COREAXITOAHBL_LIB -L COREUARTAPB_LIB -L CORESPI_LIB -L COREGPIO_LIB  -t 1fs presynth.tb
